...
public class undead_viking_0 extends EntityZombie{
  
  public undead_viking_0(EntityTypes<? extends EntityZombie> var0, World var1) {
    super(var0, var1);
  }
  ...
  public static Zombie spawn(Location location) {
	  ...
	  undead_viking_0 entity = new undead_viking_0(EntityTypes.ZOMBIE, world);
	  entity.setLocation(location.getX(), location.getY(), location.getZ(), location.getYaw(), location.getPitch());
	  world.addEntity(entity, SpawnReason.NATURAL);
	  entity.setCanPickupLoot(false);
	  Zombie entity0 = (Zombie) ((CraftEntity)entity.getBukkitEntity());
	  entity0.setAI(true);
