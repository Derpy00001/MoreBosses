...
public class Sheep {
	...
	public static void newsheep(LivingEntity entity, Plugin plugin) {
		...
		entity.setMaxHealth(entity.getMaxHealth()*plugin.getConfig().getInt("health_scale.tier0.sheep"));
		...
		ai2.setBaseValue(ai2.getBaseValue()*plugin.getConfig().getInt("damage_scale.tier0.sheep"));
