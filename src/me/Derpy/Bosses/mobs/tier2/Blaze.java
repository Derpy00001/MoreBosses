...
public class Blaze {
	...
	public static void newblaze(LivingEntity entity, Plugin plugin) {
		if(plugin.getConfig().getBoolean("bosses.has_glow")) {
			entity.setGlowing(true);
		}
		entity.setSilent(true);
		// getnearbyentities
		// on loop every few ticks
		// set every mob on fire
		// within radius
		...
		entity.setMaxHealth(entity.getMaxHealth()*plugin.getConfig().getInt("health_scale.tier2.blaze"));
		...
		ai2.setBaseValue(ai2.getBaseValue()*plugin.getConfig().getInt("damage_scale.tier2.blaze"));
