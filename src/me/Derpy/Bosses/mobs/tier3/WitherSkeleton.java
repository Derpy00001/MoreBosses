...
public class WitherSkeleton {
	...
	public static void newwitherskeleton(LivingEntity entity, Plugin plugin) {
		...
		entity.setMaxHealth(entity.getMaxHealth()*plugin.getConfig().getInt("health_scale.tier3.skeleton_wither"));
		...
		ai2.setBaseValue(ai2.getBaseValue()*plugin.getConfig().getInt("damage_scale.tier3.skeleton_wither"));
